    ...
    public partial class Form1 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            try {
                ...
                String pptfilename = label1.Text;
                // オープン
...
//                app.Presentations[1].SaveAs(textBox1.Text + "\\b.png", PpSaveAsFileType.ppSaveAsPNG);
                //ppt.SaveAs(textBox1.Text + "\\a.png", PpSaveAsFileType.ppSaveAsPNG);
